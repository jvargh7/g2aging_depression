...
rm(hrs_unique_df,hrs_unique_svy,hrs_all,hrs_all_diagnosed_svy)
...
before_imputation <- hrs_all_exposure_available %>% 
...
method["control_a1c"] <- "~I(((a1c_adj<6.5 & age <65)|(a1c_adj<7.5 & age >=65))*1)"
pred[c("control_a1c"),] <- 0
method["fu_control_a1c"] <- "~I(((fu_a1c_adj<6.5 & fu_age <65)|(fu_a1c_adj<7.5 & fu_age >=65))*1)"
...
saveRDS(mi_dfs, paste0(path_g2a_depression_folder,"/working/g2adhrs_sensitivity multiple imputation.RDS"))
